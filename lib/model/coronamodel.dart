...
//
//     final coronaCaseModelClass = coronaCaseModelClassFromJson(jsonString);

import 'dart:convert';

List<CoronaCaseModelClass> coronaCaseModelClassFromJson(String str) => List<CoronaCaseModelClass>.from(json.decode(str).map((x) => CoronaCaseModelClass.fromJson(x)));

String coronaCaseModelClassToJson(List<CoronaCaseModelClass> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class CoronaCaseModelClass {
  String country;
  ...
  factory CoronaCaseModelClass.fromJson(Map<String, dynamic> json) => CoronaCaseModelClass(
